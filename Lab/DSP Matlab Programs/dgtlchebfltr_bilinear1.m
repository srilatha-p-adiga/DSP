...
% figure(5)
% stem(freq,abs(sptrum))
% title('Stemmed Spectrum of the Composite Signal')
% xlabel('Frequency in Hz..')
% ylabel('Amplitude')
% grid
% pause
...
% figure(7)
% stem(freq,abs(otpt_sptrum))
% title('Stemmed Spectrum of the Filter Output')
% xlabel('Frequency in Hz..')
% ylabel('Amplitude')
% grid
% pause
